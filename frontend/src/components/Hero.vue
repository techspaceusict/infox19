  ...
  <div class="hero">
    <div id="logo">
      ...
      >
        ...
        <polygon
          class="st0"
          style="fill-opacity: 0; stroke-width: 2; stroke: #0abcf2; filter: url(#glow);"
      ...
      <div id="eventInfo">
        <div style="color:#b69ee2;font-weight: bold">OCT 15TH-17TH 2019</div>
...
#logo {
  ...
  text-align: center;
  animation: slideUp 0.8s ease-in-out 3.3s;

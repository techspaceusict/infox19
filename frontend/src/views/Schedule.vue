...
.lrdline_1 {
  ...
  background-image: linear-gradient(
    to right bottom,
    rgba(224, 220, 12, 0.85),
    rgba(117, 106, 6, 0.85)
  );
}

.codexpress_1 {
  grid-area: codexpress_1;
  background-image: linear-gradient(
    to right bottom,
    rgba(224, 220, 12, 0.918),
    rgba(47, 117, 6, 0.85)
  );
}

.hackerman_1 {
  grid-area: hackerman_1;
  background-image: linear-gradient(
    to right bottom,
    rgba(217, 12, 224, 0.85),
    rgba(104, 6, 117, 0.85)
  );
}
...
.uh_inaug_1 {
  background-image: linear-gradient(
    to right bottom,
    rgba(224, 12, 143, 0.85),
    rgba(117, 6, 108, 0.85)
  );
  grid-area: uh_inaug_1;
}
...
.marvel_world_2 {
  ...
  grid-area: marvel_world_2;
}
.uh_2 {
  background-image: linear-gradient(
    to right bottom,
    rgba(224, 150, 12, 0.85),
    rgba(117, 69, 6, 0.85)
  );
  grid-area: uh_2;
}
...
.spacejam_2 {
  ...
  grid-area: spacejam_2;
}
.clashonlan_2 {
  background-image: linear-gradient(
    to right bottom,
    rgba(12, 192, 224, 0.85),
    rgba(6, 110, 117, 0.85)
  );
  grid-area: clashonlan_2;
}
.treasurehunt_2 {
  background-image: linear-gradient(
    to right bottom,
...
.about-content {
  ...
  width: 100%;
  color: #a30404;
  /* animation: title-overlay 1s ease-in-out; */
